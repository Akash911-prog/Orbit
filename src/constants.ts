...
export const KEYWORDS: Record<string, TokenType> = {
    ...
    nova: TokenType.KeywordNova,
    drift: TokenType.KeywordDrift,
    decay: TokenType.KeywordDecay,
    fire: TokenType.KeywordFire,
    null: TokenType.KeywordNull,
    Map: TokenType.KeywordMap,
    ...
    u8: TokenType.KeywordU8,
    u16: TokenType.KeywordU16,
